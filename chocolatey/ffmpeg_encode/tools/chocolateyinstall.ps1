...
# Remove 'v' prefix if present (Chocolatey version should match release tag format)
...
$packageArgs = @{
  ...
  # Update these when you publish a new version - use: choco install checksum -y; checksum -t sha256 -f path\to\file
  checksum      = 'C2148DE6483452B00A301E87E067CB8F'
  checksumType  = 'sha256'
  checksum64    = 'C2148DE6483452B00A301E87E067CB8F'
