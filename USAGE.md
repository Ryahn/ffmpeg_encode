...
- **Share encoding statistics**: Master toggle (default on). When enabled, the app POSTs aggregate totals to `{base}/api/stats` after each successful encode (no authentication).
